...
2. corpus: exact workload. Bench name + N + the fixed workload params
   in `bench/*.ts` (append: `value` 1000..9999, `actor: bench`;
...
[bench-check] corpus n=2000 value=1000+(i%9000) actor=bench
...
HONESTY: PASS bench=append head=d03e683b8e40acf3a484617cdfd42a254a61a358 bun=1.4.0 corpus="n=2000 value=1000+(i%9000) actor=bench" log=/tmp/bench-check-append-2000.log
```
